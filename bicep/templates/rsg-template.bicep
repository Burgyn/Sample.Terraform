...
resource sites_gabo_dev_eshop_authorization_api_name_web 'Microsoft.Web/sites/config@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_authorization_api_name_resource.name}/web'
  location: 'West Europe'
  properties: {
    numberOfWorkers: 1
    defaultDocuments: []
    ...
    publishingUsername: '$gabo-dev-eshop-authorization-api'
...
resource sites_gabo_dev_eshop_basket_api_name_web 'Microsoft.Web/sites/config@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_basket_api_name_resource.name}/web'
  location: 'West Europe'
  properties: {
    numberOfWorkers: 1
    defaultDocuments: []
    ...
    logsDirectorySizeLimit: 35
    detailedErrorLoggingEnabled: false
    publishingUsername: '$gabo-dev-eshop-basket-api'
    azureStorageAccounts: {}
    scmType: 'LocalGit'
    use32BitWorkerProcess: false
    webSocketsEnabled: false
...
resource sites_gabo_dev_eshop_catalog_api_name_web 'Microsoft.Web/sites/config@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_catalog_api_name_resource.name}/web'
  location: 'West Europe'
  properties: {
    numberOfWorkers: 1
    defaultDocuments: []
    ...
    logsDirectorySizeLimit: 35
    detailedErrorLoggingEnabled: false
    publishingUsername: '$gabo-dev-eshop-catalog-api'
    azureStorageAccounts: {}
    scmType: 'LocalGit'
    use32BitWorkerProcess: false
    webSocketsEnabled: false
...
resource sites_gabo_dev_eshop_emails_api_name_web 'Microsoft.Web/sites/config@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_emails_api_name_resource.name}/web'
  location: 'West Europe'
  properties: {
    numberOfWorkers: 1
    defaultDocuments: []
    ...
    logsDirectorySizeLimit: 35
    detailedErrorLoggingEnabled: false
    publishingUsername: '$gabo-dev-eshop-emails-api'
    azureStorageAccounts: {}
    scmType: 'LocalGit'
    use32BitWorkerProcess: false
    webSocketsEnabled: false
...
resource sites_gabo_dev_eshop_orders_api_name_web 'Microsoft.Web/sites/config@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_orders_api_name_resource.name}/web'
  location: 'West Europe'
  properties: {
    numberOfWorkers: 1
    defaultDocuments: []
    ...
    logsDirectorySizeLimit: 35
    detailedErrorLoggingEnabled: false
    publishingUsername: '$gabo-dev-eshop-orders-api'
    azureStorageAccounts: {}
    scmType: 'LocalGit'
    use32BitWorkerProcess: false
    webSocketsEnabled: false
...
resource sites_gabo_dev_eshop_tenant_api_name_web 'Microsoft.Web/sites/config@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_tenant_api_name_resource.name}/web'
  location: 'West Europe'
  properties: {
    numberOfWorkers: 1
    defaultDocuments: []
    ...
    logsDirectorySizeLimit: 35
    detailedErrorLoggingEnabled: false
    publishingUsername: '$gabo-dev-eshop-tenant-api'
    azureStorageAccounts: {}
    scmType: 'LocalGit'
    use32BitWorkerProcess: false
    webSocketsEnabled: false
...
resource sites_gabo_dev_eshop_users_api_name_web 'Microsoft.Web/sites/config@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_users_api_name_resource.name}/web'
  location: 'West Europe'
  properties: {
    numberOfWorkers: 1
    defaultDocuments: []
    ...
    logsDirectorySizeLimit: 35
    detailedErrorLoggingEnabled: false
    publishingUsername: '$gabo-dev-eshop-users-api'
    azureStorageAccounts: {}
    scmType: 'LocalGit'
    use32BitWorkerProcess: false
    webSocketsEnabled: false
...
resource sites_gabo_dev_eshop_authorization_api_name_sites_gabo_dev_eshop_authorization_api_name_azurewebsites_net 'Microsoft.Web/sites/hostNameBindings@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_authorization_api_name_resource.name}/${sites_gabo_dev_eshop_authorization_api_name}.azurewebsites.net'
  location: 'West Europe'
  properties: {
    siteName: 'gabo-dev-eshop-authorization-api'
    hostNameType: 'Verified'
  }
}

resource sites_gabo_dev_eshop_basket_api_name_sites_gabo_dev_eshop_basket_api_name_azurewebsites_net 'Microsoft.Web/sites/hostNameBindings@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_basket_api_name_resource.name}/${sites_gabo_dev_eshop_basket_api_name}.azurewebsites.net'
  location: 'West Europe'
  properties: {
    siteName: 'gabo-dev-eshop-basket-api'
    hostNameType: 'Verified'
  }
}

resource sites_gabo_dev_eshop_catalog_api_name_sites_gabo_dev_eshop_catalog_api_name_azurewebsites_net 'Microsoft.Web/sites/hostNameBindings@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_catalog_api_name_resource.name}/${sites_gabo_dev_eshop_catalog_api_name}.azurewebsites.net'
  location: 'West Europe'
  properties: {
    siteName: 'gabo-dev-eshop-catalog-api'
    hostNameType: 'Verified'
  }
}

resource sites_gabo_dev_eshop_emails_api_name_sites_gabo_dev_eshop_emails_api_name_azurewebsites_net 'Microsoft.Web/sites/hostNameBindings@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_emails_api_name_resource.name}/${sites_gabo_dev_eshop_emails_api_name}.azurewebsites.net'
  location: 'West Europe'
  properties: {
    siteName: 'gabo-dev-eshop-emails-api'
    hostNameType: 'Verified'
  }
}

resource sites_gabo_dev_eshop_orders_api_name_sites_gabo_dev_eshop_orders_api_name_azurewebsites_net 'Microsoft.Web/sites/hostNameBindings@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_orders_api_name_resource.name}/${sites_gabo_dev_eshop_orders_api_name}.azurewebsites.net'
  location: 'West Europe'
  properties: {
    siteName: 'gabo-dev-eshop-orders-api'
    hostNameType: 'Verified'
  }
}

resource sites_gabo_dev_eshop_tenant_api_name_sites_gabo_dev_eshop_tenant_api_name_azurewebsites_net 'Microsoft.Web/sites/hostNameBindings@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_tenant_api_name_resource.name}/${sites_gabo_dev_eshop_tenant_api_name}.azurewebsites.net'
  location: 'West Europe'
  properties: {
    siteName: 'gabo-dev-eshop-tenant-api'
    hostNameType: 'Verified'
  }
}

resource sites_gabo_dev_eshop_users_api_name_sites_gabo_dev_eshop_users_api_name_azurewebsites_net 'Microsoft.Web/sites/hostNameBindings@2018-11-01' = {
  name: '${sites_gabo_dev_eshop_users_api_name_resource.name}/${sites_gabo_dev_eshop_users_api_name}.azurewebsites.net'
  location: 'West Europe'
  properties: {
    siteName: 'gabo-dev-eshop-users-api'
    hostNameType: 'Verified'
  }
}